...
--                               software_tools, marketing, recruiter_labor, advertising,
--                               background_checks, drug_screening, payroll, employee_wages,
--                               referral_bonuses, training, other
--
-- See also: 20260805_opex_category_extension.sql for ADD VALUE + seed rows.
...
CREATE TYPE public.operating_expense_category AS ENUM (
  'recruiter_salaries', 'accounting_salaries', 'office_rent', 'software_tools', 'marketing',
  'recruiter_labor', 'advertising', 'background_checks', 'drug_screening', 'payroll',
  'employee_wages', 'referral_bonuses', 'training', 'other'
);
